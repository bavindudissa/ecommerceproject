    							...
    							<tr>
    								...
    								<td class="easy_ufdc_page_to_implement_div">
                                        ...
                                        <ul class="easy_ufdc_page_to_implement">
                                            ...
                                            <li class="eufdc_premium"><input type="radio" name="easy_ufdc_page" id="easy_ufdc_page_thank_you" value="thank_you" <?php checked($easy_ufdc_page=='thank_you' || !$easy_ufdc_page); ?> />
                                            ...
                                            <li class="eufdc_premium"><input type="radio" name="easy_ufdc_page" id="easy_ufdc_page_customer_order" value="customer_order" <?php checked($easy_ufdc_page=='customer_order' || !$easy_ufdc_page); ?> />
...
<hr>
            ...
            <code>
                ...
                <br /><br />
                add_action('eufdc_order_attachments', 'eufdc_order_attachments_callback', 10, 2);<?php echo esc_html(str_repeat('<br />', 2)); ?>
...
<ul class="list-group orphan_files">
        ...
        <div class="row mt-3 eufdc_help_section">
        	...
        	<ul class="position-relative">
                ...
                <li><a class="btn btn-sm btn-warning" href="http://demo.androidbubble.com/contact/" target="_blank"><?php _e('Contact Developer', 'easy-upload-files-during-checkout'); ?></a><i class="fas fa-headset"></i></li>
